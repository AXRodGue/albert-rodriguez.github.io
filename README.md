...
Una plataforma web de tecnología restringía el registro a usuarios según su edad (mínimo 18 años, máximo 65 años). Existían reportes de que usuarios de 17 años lograban registrarse debido a una mala lógica en las validaciones del backend.
...
Listas de Comprobación Parametrizadas: Utilicé la potencia de pytest.mark.parametrize para ejecutar una sola prueba matemática pasándole 
múltiples datos fronterizos (17, 18, 65, 66 años).
...
Cada vez que el equipo de desarrollo añadía un nuevo método de pago o una actualización estética al módulo de e-commerce, funciones que ya servían (como agregar productos o calcular el total del carrito) dejaban de funcionar misteriosamente.
